        ...
        <section className="min-h-screen bg-[var(--color-bg-primary)] py-16 px-4" style={{ fontFamily: "Arial, sans-serif" }}>
            ...
            <div className="max-w-3xl mx-auto bg-[var(--color-bg-secondary)] rounded-2xl p-8 md:p-10">
                <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                    {success && (
                        <div className="rounded-md bg-emerald-600 text-white px-4 py-3">Your appointment has been confirmed.</div>
                    )}
                    ...
                    <div className="flex gap-4 justify-between">
                        ...
                        <button type="submit" disabled={!form.date || !form.time || !form.serviceType} className={`flex-1 py-2 rounded-md ${!form.date || !form.time || !form.serviceType ? 'bg-[var(--color-primary)]/60 text-white cursor-not-allowed opacity-70' : 'bg-[var(--color-primary)] text-white'}`}>Confirm Appointment</button>
                    </div>
