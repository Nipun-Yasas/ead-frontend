    ...
    return (
        <section className="bg-[#171717] text-[var(--color-text-primary)] py-18 font-sans" aria-labelledby="why-choose-heading">
            <div className="max-w-7xl mx-auto px-6 text-center">
                ...
                <p className="max-w-3xl mx-auto mb-10 text-base md:text-xl text-[#717182]">Experience excellence in automotive service with real-time tracking and professional care</p>
